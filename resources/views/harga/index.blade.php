...
@section('content')
    ...
    <div class="d-flex gap-3 space-x-3">
        ...
        @role('admin')
        <div class="m-2 mb-4">
            <a href="#" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#modalHarga">
                        ...
                        <div class="modal-body">
                            <form id="form-harga">
                                ...
                                <div>
                                    ...
                                    <p> Harap input harga tanpa menggunakan atribute koma (,) atau titik (.)</p>
                                </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="card shadow mb-0">
                        <div class="modal-body">
                            ...
                            {{-- ppn --}}
                            <div class="form-group mb-3">
                                <label for="edit_ppn">PPN (11%)</label>
                                <input type="number" name="ppn" id="edit_ppn" class="form-control" readonly>
                            </div>
                        ...
                        <div class="modal-footer">
                            <button class="btn btn-sm btn-secondary" data-bs-dismiss="modal" type="button">Tutup</button>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <ul class="list-group pb-3">
                            <li class="list-group-item"><strong>Nama Obat</strong> <span id="detail_nama_obat"></span></li>
                        </ul>
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function() {
                ...
                function updateHarga() {
                    ...
                    const nilaippn = hp * 0.11;
                    ppn.value = nilaippn.toFixed(0);
                    hargaJual.value = hp + m + nilaippn;
                }

                hargaPokok.addEventListener("input", updateHarga);
                margin.addEventListener("input", updateHarga);

                // Untuk modal edit
                const hargaPokokEdit = document.getElementById("edit_harga_pokok");
                const marginEdit = document.getElementById("edit_margin");
                const ppnEdit = document.getElementById("edit_ppn");
                const hargaJualEdit = document.getElementById("edit_harga_jual");

                function updateEditHarga() {
                    const hp = parseFloat(hargaPokokEdit.value) || 0;
                    const m = parseFloat(marginEdit.value) || 0;
                    const nilaippn = hp * 0.11;
                    ppnEdit.value = nilaippn.toFixed(0);
                    hargaJualEdit.value = hp + m + nilaippn;
                }

                hargaPokokEdit.addEventListener("input", updateEditHarga);
                marginEdit.addEventListener("input", updateEditHarga);

                const editModal = document.getElementById('editModalHarga');
                editModal.addEventListener('shown.bs.modal', updateEditHarga);
            });
        </script>
    </div>
